...
// let renderWidth = WIDTH * 4, renderHeight = HEIGHT * 4;
...
// var affine = {
//   world: {
//     size(p: { x: number; y: number; z: number; }, size: { x: number; y: number; z: number; }) {
//       return {
//         x: p.x * size.x,
//         y: p.y * size.y,
//         z: p.z * size.z
...
//     },
//     rotate: {
//       x(p: { x: any; y: any; z: any; }, rotate: { x: any; }) {
//         return {
//           x: p.x,
...
//         };
//       },
//       y(p: { x: any; y: any; z: any; }, rotate: { y: any; }) {
//         return {
...
//         };
//       },
//       z(p: { x: any; y: any; z: any; }, rotate: { z: any; }) {
//         return {
...
//       }
//     },
//     position(p: { x: any; y: any; z: any; }, position: { x: any; y: any; z: any; }) {
//       return {
//         x: p.x + position.x,
//         y: p.y + position.y,
//         z: p.z + position.z
...
//       };
//     },
//     righthandedReversal(p: { x: any; y: any; z: any; }) {
//       return {
//         x: p.x,
//         y: -p.y,
//         z: p.z,
...
//     }
//   },
//   perspective(p: { x: any; y: any; z: any; }) {
//     return {
...
//     };
//   },
//   display(p: { x: any; y: any; z: any; p?: any; }, display: { x: any; y: any; z: any; }) {
//     return {
//       x: p.x + display.x,
//       y: p.y + display.y,
//       z: p.z + display.z,
...
//     };
//   },
//   process(model: { x: number; y: number; z: number; }, size: { x: number; y: number; z: number; }, rotate: { x?: any; y?: any; z?: any; }, position: { x: any; y: any; z: any; }, display: { x: any; y: any; z: any; }) {
...
// function vertex3d(this: any, param: { vertex?: any; size?: any; rotate?: any; position?: any; }) {
//   this.affineIn = {};
//   this.affineOut = {};
...
// function dtr(v: number) { return v * Math.PI / 180; }
// //cordinate system transformation.
// //polar to rectangle.
// function polarToRectangle(dX: number, dY: number, radius: number) {
...
// }
// //rectangle to polar.
// function rectangleToPolar(x: number, y: number, z: number) {
//   var xD, yD, zD;
//   if (x === 0) {
//     xD = 0.001;
//   } else {
...
// }
// function closeValue(this: any, minTime: number, maxTime: number) {
//   this.flag = 0;
//   this.progress = 0;
//   this.startTime = 0;
//   this.durationTime = 0;
...
// /* class */
// function sphere(this: any, arg: { radius: any; particleNum: any; center: any; buffers: any; }) {
//   this.flag = true;
//   this.type = "_";
...
//   this.charsMap = {};
//   for (var i in chars) {
//     var buffer = this.buffers[i].getContext("2d").getImageData(0, 0, 100, 100).data;
//     this.charsMap[i] = [];
//     var self = this;
//     for (let j = 0; j < this.particleNum; j++) {
//       var redo = function () { //eslint-disable-line
...
// function textChanger(text: string | any[], sphereRadius: number, sphereSpace: number, unitTime: number | undefined) {
...
// export default class Kewl extends Layer {
//   async initialise() {
//     this.tempCanvas = createCanvas(renderWidth, renderHeight);
//     this.tempCtx = this.tempCanvas.getContext("2d");
//     this.bufferImages = {};
//     this.buffers = {};
//     await this.createBufferImages();
//     await this.bufferDraw();
...
//     textSetChanger();
//   }
//   async createBufferImages() {
//     return Promise.all(Object.keys(chars).map(async(c) => {
//       this.bufferImages[c] = await loadImage(chars[c]);
//     }));
//   }
//   async bufferDraw() {
//     return Promise.all(Object.keys(chars).map(async(c) => {
//       this.buffers[c] = createCanvas(100, 100);
//       this.buffers[c].getContext("2d").drawImage(
//         this.bufferImages[c],
//         0,
//         0,
//         100,
...
//     this.tempCtx.clearRect(0, 0, renderWidth, renderHeight);
//     this.tempCtx.fillStyle = backgroundColor;
//     this.tempCtx.fillRect(0, 0, renderWidth, renderHeight);
//     this.tempCtx.strokeStyle = strokeColor;
//     for (var i = 0; i < sphereNum; i++) {
//       s[i].draw(this.tempCtx);
//     }
